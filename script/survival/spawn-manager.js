...
export const manageSpawns = () => {
    ...
    if (chaos < 2) {
        ...
        else enemy = new Tracker(level, new SinglePointPath(x, y), new Loot(RANDOM, 1))
    } else if (chaos < 20) {
        ...
        else if (chance < 0.84) enemy = new Tracker(level, new SinglePointPath(x, y), new Loot(RANDOM, 1))
        ...
        else if (chance < 0.75) enemy = new Tracker(level, new SinglePointPath(x, y), new Loot(RANDOM, 1))
        ...
        else if (chance < 0.66) enemy = new Tracker(level, new SinglePointPath(x, y), new Loot(RANDOM, 1))
