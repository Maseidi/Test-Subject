...
import { FLASHBANG_LOOT, GRENADE_LOOT, MAGNUM_AMMO_LOOT } from '../../loots-list.js'
...
export const enemies = new Map([
    [37, [
        ...
        new Tracker(1, 1000, 140, '3', GRENADE_LOOT),
        new Tracker(1, 1000, 240, '3', FLASHBANG_LOOT),
        new Tracker(1, 1000, 340, '3', MAGNUM_AMMO_LOOT),
