...
import { FLASHBANG_LOOT, GRENADE_LOOT, Loot, MAGNUM_AMMO_LOOT, SingleLoot, SPAS } from '../../loot.js'
...
export const enemies = new Map([
    [37, [
        ...
        new Tracker(1, 1000, 140, '3', new Loot(GRENADE_LOOT, 1)),
        new Tracker(1, 1000, 240, '3', new Loot(FLASHBANG_LOOT, 2)),
        new Tracker(1, 1000, 340, '3', new SingleLoot(SPAS)),
